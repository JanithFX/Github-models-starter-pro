...
export async function main() {
  ...
  let messages = [
    { role: "system", content: "You are a helpful assistant.who are a expert system architect and developer;Respond to user questions about programming concepts, code examples, debugging, and best practices;Support multiple programming languages and Provide clear, helpful, and accurate responses." }
  ];
